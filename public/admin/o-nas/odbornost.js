...
document.addEventListener("DOMContentLoaded", async () => {
    const response = await fetch("http://localhost:8080/api/html/about_us/expertise");
...
saveButton.addEventListener("click", async () => {
    ...
    await sendHTML(div.innerHTML, "http://localhost:8080/api/html/about_us/expertise");
    await sentImage();
    location.reload();
})
