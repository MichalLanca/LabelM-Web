...
if(currentPage === "individualni-pece-o-vlasy"){
    ...
    stepSixChoices.forEach((choice) => {
        choice.addEventListener("click", function(){
            ...
            setTimeout(() => {
                window.location.href = "konzultace";
            }, 400)
        })
    })
    const options = document.querySelectorAll(".step_5 li");
...
<div class="text-center text-teal-900 xl:mx-6 2xl:mx-12">
    ...
    function carouselNo1(){

        const btnBackNo1 = document.querySelector(".btn_back_no1");
        const btnNextNo1 = document.querySelector(".btn_next_no1");
        const sliderNo1 = document.querySelector(".carousel_no1");
        const images = sliderNo1.querySelectorAll(".flex-col");
        ...
        let endPosition = 0;
        let dragDistance;
        const links = sliderNo1.querySelectorAll("a");
        ...
        while(i < noOneList.length){
            listButtons += buttonMobile;
            i++;
        }

        document.querySelector(".mobile_buttons").innerHTML = listButtons;
        ...
        btnBackNo1.addEventListener("click", slideToLeft);
        btnNextNo1.addEventListener("click", slideToRight);


        window.addEventListener("resize", responsivePoint);
        window.addEventListener("load", responsivePoint);
        ...
        function enableDisableButton(){
            ...
            if(productIndex > 0){
            btnBackNo1.removeAttribute("disabled");
            } else if (productIndex === 0){
            btnBackNo1.setAttribute("disabled", "");
            }
            if (productIndex === images.length - numberOfImages){
            btnNextNo1.setAttribute("disabled", "");
            } if (productIndex < images.length - numberOfImages){
                btnNextNo1.removeAttribute("disabled", "")
            }
        }

        function responsivePoint() {

            const imageStyles = getComputedStyle(images[0]);
            let marginLeft = parseInt(imageStyles.getPropertyValue("margin-left"), 10);
            width = images[0].clientWidth + (2 * marginLeft);

        
            if(window.innerWidth > 1023){
            if(numberOfImages != 3){
                windowChange = 3 - numberOfImages;
            ...
            if(window.innerWidth > 767){
                if(productIndex === 0){
                    sliderNo1.style.transform = `translateX(-${(marginLeft)}px)`
                } else {
                    sliderNo1.style.transform = `translateX(-${(productIndex * width + marginLeft)}px)`;
                }
            } else if(window.innerWidth < 768){
        ...
        sliderNo1.addEventListener("mousedown", (e) => {
            isDown = true;
            startPositionX = e.clientX;
            sliderNo1.style.transition = "none";
            currentTranslateX = getCurrentTranslateX(sliderNo1);
            })

        sliderNo1.addEventListener("touchstart", (e) => {
            isDown = true;
        ...
        sliderNo1.addEventListener("mousemove", (e) => {
        if(isDown){
            isDragging = true;
            links.forEach((link) => {
            ...
            sliderNo1.style.transform = `translateX(${newTranslateX}px)`;
        } 
        });

        sliderNo1.addEventListener("touchmove", (e) => {
            if(isDown){
                isDragging = true;
                links.forEach((link) => {
                link.removeAttribute("href");})
                ...
                const dragDistanceY = e.clientY - startY;
        ...
        sliderNo1.addEventListener("mouseup", () => {
            isDown = false;
        if (!isDragging) return;
        isDragging = false;
        sliderNo1.style.transition = "";
        
        if (endPosition > startPositionX && dragDistance >= (images[0].clientWidth / 4) && productIndex != 0) {
            productIndex -= 1;
            responsivePoint();
            }
        else if (endPosition < startPositionX && dragDistance <= -(images[0].clientWidth / 4) && productIndex < (images.length - numberOfImages)) {
            productIndex += 1;
            responsivePoint();
        } else {
            responsivePoint();
        ...
        sliderNo1.addEventListener("touchend", () => {
            isDown = false;
            if (!isDragging) return;
            isDragging = false;
            sliderNo1.style.transition = "";
        ...
        sliderNo1.addEventListener("mouseleave", () => {
            if (!isDragging) return;
            isDragging = false;
            sliderNo1.style.transition = '';
          });
        ...
        function progressBar(){
            const oneMove = 100 / (images.length - numberOfImages);
            let currentPosition = productIndex * oneMove;
    ...
    function carouselNo2(){

        const btnBackNo1 = document.querySelector(".btn_back_no2");
        const btnNextNo1 = document.querySelector(".btn_next_no2");
        const sliderNo1 = document.querySelector(".carousel_no2");
        const images = sliderNo1.querySelectorAll(".flex-col");
        let numberOfImages = 3;
        let productIndex = 0;
        let isDragging = false;
        ...
        const links = sliderNo1.querySelectorAll("a");
        const originalHrefs = Array.from(links).map((link) => link.getAttribute('href'));
        const progress = document.querySelector(".progress_bar_2");
        let i = 0;
        listButtons = [];
        let startY;

        while(i < noTwoList.length){
            listButtons += buttonMobile;
            i++;
        }

        document.querySelector(".mobile_buttons_2").innerHTML = listButtons;
        const mobileButtons = document.querySelectorAll(".mobile_buttons_2 button");
        ...
        sliderNo1.addEventListener("touchmove", (e) => {
                if(isDown){
                    ...
                    dragDistance = e.touches[0].clientX - startPositionX;
                    endPosition = e.touches[0].clientX;
                    const dragDistanceY = e.touches[0].clientY - startY;
                    if (Math.abs(dragDistanceX) > Math.abs(dragDistanceY)) {
                        const newTranslateX = currentTranslateX + dragDistance;
                        sliderNo1.style.transform = `translateX(${newTranslateX}px)`;
                    }
    ...
    function carouselNo3(){

        const btnBackNo1 = document.querySelector(".btn_back_no3");
        const btnNextNo1 = document.querySelector(".btn_next_no3");
        const sliderNo1 = document.querySelector(".carousel_no3");
        const images = sliderNo1.querySelectorAll(".flex-col");
        let numberOfImages = 3;
        let productIndex = 0;
        let isDragging = false;
        ...
        const links = sliderNo1.querySelectorAll("a");
        const originalHrefs = Array.from(links).map((link) => link.getAttribute('href'));
        const progress = document.querySelector(".progress_bar_3");
        let i = 0;
        listButtons = [];
        let startY;

        while(i < noThreeList.length){
            listButtons += buttonMobile;
            i++;
        }

        document.querySelector(".mobile_buttons_3").innerHTML = listButtons;
        const mobileButtons = document.querySelectorAll(".mobile_buttons_3 button");
    ...
    function carouselNo4(){

        const btnBackNo1 = document.querySelector(".btn_back_no4");
        const btnNextNo1 = document.querySelector(".btn_next_no4");
        const sliderNo1 = document.querySelector(".carousel_no4");
        const images = sliderNo1.querySelectorAll(".flex-col");
        let numberOfImages = 3;
        let productIndex = 0;
        let isDragging = false;
        ...
        const links = sliderNo1.querySelectorAll("a");
        const originalHrefs = Array.from(links).map((link) => link.getAttribute('href'));
        const progress = document.querySelector(".progress_bar_4");
        let i = 0;
        listButtons = [];
        let startY;

        while(i < noFourList.length){
            listButtons += buttonMobile;
            i++;
        }

        document.querySelector(".mobile_buttons_4").innerHTML = listButtons;
        const mobileButtons = document.querySelectorAll(".mobile_buttons_4 button");
    ...
    function carouselNo5(){

        const btnBackNo1 = document.querySelector(".btn_back_no5");
        const btnNextNo1 = document.querySelector(".btn_next_no5");
        const sliderNo1 = document.querySelector(".carousel_no5");
        const images = sliderNo1.querySelectorAll(".flex-col");
        let numberOfImages = 3;
        let productIndex = 0;
        let isDragging = false;
        ...
        const links = sliderNo1.querySelectorAll("a");
        const originalHrefs = Array.from(links).map((link) => link.getAttribute('href'));
        const progress = document.querySelector(".progress_bar_5");
        let i = 0;
        listButtons = [];
        let startY;

        while(i < noFiveList.length){
            listButtons += buttonMobile;
            i++;
        }

        document.querySelector(".mobile_buttons_5").innerHTML = listButtons;

        const mobileButtons = document.querySelectorAll(".mobile_buttons_5 button");
